...
function registerConceptToolsWithCaller(server: McpServer, call: BrainCall): void {
  ...
  server.tool(
    'trading_concept_status',
    'Get Trading Brain concept abstraction status: total concepts, levels, transferability, top concepts.',
    {},
    async () => {
