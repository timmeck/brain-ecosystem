...
function registerConceptToolsWithCaller(server: McpServer, call: BrainCall): void {
  ...
  server.tool(
    'marketing_concept_status',
    'Get Marketing Brain concept abstraction status: total concepts, levels, transferability, top concepts.',
    {},
    async () => {
  ...
  server.tool(
    'marketing_concept_transferable',
