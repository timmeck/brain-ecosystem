...
function registerDebateToolsWithCaller(server: McpServer, call: BrainCall): void {
  ...
  server.tool(
    ...
    'Challenge a marketing principle by searching for contradicting evidence (Advocatus Diaboli). Returns resilience score and outcome.',
  ...
  server.tool(
    'marketing_challenge_history',
    'View recent marketing principle challenges with their outcomes and resilience scores.',
  ...
  server.tool(
    'marketing_challenge_vulnerable',
    'Show marketing principles with the lowest resilience scores — the most vulnerable beliefs.',
    ...
    async (params) => {
      ...
      const lines = [`# Most Vulnerable Marketing Principles\n`];
