...
function registerResponderToolsWithCaller(server: McpServer, call: BrainCall): void {
  ...
  server.tool(
    'marketing_responder_status',
    'Get the AutoResponder status — shows how many anomalies Marketing Brain has automatically responded to, success rate, and recent actions.',
    {},
    async () => {
  ...
  server.tool(
    'marketing_responder_history',
    'Get history of automatic responses Marketing Brain has taken in reaction to anomalies.',
    {
  ...
  server.tool(
    'marketing_responder_rules',
    'List the active response rules that Marketing Brain uses to automatically react to anomalies.',
    {},
    async () => {
