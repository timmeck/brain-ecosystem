...
| [@timmeck/brain-core](packages/brain-core) | [![npm](https://img.shields.io/npm/v/@timmeck/brain-core)](https://www.npmjs.com/package/@timmeck/brain-core) | Geteilte Infrastruktur — 60+ Engines, Synapsen, IPC, MCP, LLM, Bewusstsein, Governance, Missionen, Benachrichtigungen | — |
...
npm test             # führt alle 4.271 Tests aus
```
